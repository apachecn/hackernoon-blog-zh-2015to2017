...
The inside of a [Google Datacenter](https://www.google.co.uk/about/datacenters/inside/streetview/).
...
不是说 AdSense 慢:几百毫秒对于页面资产加载来说其实已经很快了。这些延迟目标最初是在 56k 调制解调器还在广泛使用时设定的。
